...
// ファイルの新規作成・メタデータ更新はGOOGLE_DRIVE_API_BASE_URLと共通だが、コンテンツのアップロード
// （uploadType=media）はGoogle Drive APIの仕様上、専用のuploadエンドポイントを使う必要がある
export const GOOGLE_DRIVE_UPLOAD_BASE_URL =
  process.env.GOOGLE_DRIVE_UPLOAD_BASE_URL ?? 'https://www.googleapis.com/upload/drive/v3';
